...
annika6mo <- readRDS(paste0(path, "Result/microbiome_result_at_risk_6m_hyper.RData"))

length(annika6mo)
length(annika6mo[[1]])

annika6mo[[1]][[1]]$time
apply(annika6mo[[2]][[1]]$result$ci_result, 1, uniqueClus)
apply(annika6mo[[17]][[3]]$result$ci_result, 1, uniqueClus)
